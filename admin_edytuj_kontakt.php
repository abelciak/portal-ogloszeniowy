...
<div id="colA">
<h3>Edycja podstrony <i>kontakt</i></h3>
<br>
<center>
<?
...
$query10="UPDATE podstrony SET 	zawartosc='{$_POST['tresc']}'	WHERE podstrona='2'";
...
<form action="admin_edytuj_kontakt.php?akcja=wykonaj" name="form" method="post">
